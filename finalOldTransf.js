...
Apify.main(async () => {
    const url = 'https://connection.eu-central-1.keboola.com/v2/storage/components/transformation/configs/278692691/rows/278692709';
    const method = 'PUT';
    const formData = {
        configuration: JSON.stringify({
            output: [],
            queries: ['create table blabla as select * from "ikea_cz" -- It worked from nodeJS. This is a sample query\n'
